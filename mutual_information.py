...
class Simulator(swyft.Simulator):
    ...
    def sample_prior(self):
        raise NotImplementedError("sample_prior not implemented")

    def sample_data(self, theta):
        raise NotImplementedError("generate_data not implemented")
...
if __name__ == "__main__":
    config = {
        ...
        "store_size": 10_000,
        "chunk_size": 500,
        "logratios_path": "mi-logratios",
        "trainer_dir": "mi-trainer",
        "resampler_targets": None,
        "train_fraction": 0.9,
        "val_fraction": 0.1,
    ...
    joint_samples = simulator.sample(10_000)
